...
// ─── MAIN APP ─────────────────────────────────────────────────────────────────
// ─── SHARED COMPONENTS (needed by App) ───────────────────────────────────────
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#060d1a", color: "#e2e8f0", fontFamily: "'DM Sans', 'Segoe UI', sans-serif" }}>
      ...
      {/* SECTION SWITCHER */}
      <div style={{ background: "#080e1a", borderBottom: "1px solid #1e293b", padding: "0 28px", display: "flex", alignItems: "center" }}>
        <button onClick={() => setSection("quant")}
          ...
          <span style={{ color: section === "quant" ? "#0ea5e9" : "#334155" }}>⚙</span>
          Quantitative Engine
        </button>
        <button onClick={() => setSection("intel")}
          ...
          <span style={{ color: section === "intel" ? "#10b981" : "#334155" }}>◎</span>
          Market Intelligence
        </button>
        {/* ATLAS tab pushed to the right */}
        <button onClick={() => setSection("atlas")}
          style={{ marginLeft: "auto", padding: "11px 24px", background: "transparent", border: "none", borderBottom: section === "atlas" ? "2px solid #a78bfa" : "2px solid transparent", color: section === "atlas" ? "#f1f5f9" : "#475569", fontSize: 13, fontWeight: section === "atlas" ? 700 : 400, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{ color: section === "atlas" ? "#a78bfa" : "#334155" }}>◈</span>
          ATLAS
          <span style={{ padding: "1px 7px", borderRadius: 20, fontSize: 9, fontWeight: 700, background: "#a78bfa20", color: "#a78bfa", border: "1px solid #a78bfa40", letterSpacing: "0.05em" }}>AI</span>
        </button>
      </div>

      {/* ATLAS full-page — no subnav, no sidebar */}
      {section === "atlas" && <ATLASPage />}

      {/* QUANT / INTEL SECTIONS */}
      {section !== "atlas" && (
        <>
          {/* SUB-NAV */}
          <div style={{ background: "#0a0f1a", borderBottom: "1px solid #0f1929", padding: "0 28px", display: "flex" }}>
            {quantPages.map(p => {
              const active = quantPage === p.key;
              return (
                <button key={p.key} onClick={() => setQuantPage(p.key)}
                  style={{ padding: "9px 18px", background: "transparent", border: "none", borderBottom: active ? "2px solid #0ea5e9" : "2px solid transparent", color: active ? "#0ea5e9" : "#64748b", fontSize: 12, fontWeight: active ? 600 : 400, cursor: "pointer", transition: "all 0.15s" }}>
                  {p.label}
                </button>
              );
            })}
          ...
          <div style={{ display: "flex", minHeight: "calc(100vh - 140px)" }}>
            <div style={{ flex: 1, padding: 26, overflow: "auto" }}>
              ...
              {quantPage === "agronomy"  && <AgronomyPage />}
            ...
            <div style={{ width: 210, borderLeft: "1px solid #1e293b", padding: 16, background: "#0a0f1a", flexShrink: 0 }}>
              ...
              <div style={{ marginTop: 20, borderTop: "1px solid #1e293b", paddingTop: 14 }}>
                <p style={{ color: "#334155", fontSize: 10, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 10 }}>Ask ATLAS</p>
                <button onClick={() => setSection("atlas")}
                  style={{ width: "100%", background: "#a78bfa10", border: "1px solid #a78bfa30", color: "#a78bfa", padding: "8px", borderRadius: 8, fontSize: 12, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                  ◈ Open ATLAS
                </button>
              </div>
            </div>
