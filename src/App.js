...
function CountrySelector({ onSelect }) {
  ...
  const countries = [
    { code: "France", flag: "🇫🇷", label: "France", subtitle: "Cereal heartland", accent: T.green, available: true, badge: "Quant Engine", desc: "Step inside Mathieu's farm — wheat, barley, rapeseed, corn across 7 regions. FADN-calibrated P&L engine with P-separation economics, 5-season trajectory, and full balance sheet.", engine: "FADN France · 909 farms · R²=0.993", img: "/france.jpg", fallbackColors: ["#0055A4", "#FFFFFF", "#EF4135"] },
    { code: "Brazil", flag: "🇧🇷", label: "Brazil", subtitle: "Agricultural powerhouse", accent: "#10b981", available: true, badge: "Quant Engine", desc: "Soy, corn, sugarcane, coffee and cotton across 5 macro-regions. Edit every cost line, toggle the fertiliser mix, and watch the P&L update in real time — from the farmer's field to the port.", engine: "Embrapa · Conab / Cepea · CVA × OCP Module A 2025", img: "/brazil.jpg", fallbackColors: ["#009C3B", "#FFDF00", "#002776"] },
  ];
  return (
    <div style={{ minHeight: "100vh", background: T.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans','Segoe UI',sans-serif", padding: "40px 24px", position: "relative" }}>
      ...
      <div style={{ display: "flex", gap: 20, justifyContent: "center", flexWrap: "wrap", maxWidth: 900 }}>
        {countries.map((c, i) => (
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ display: "flex", gap: 0, background: T.card, border: `1px solid ${T.border}`, borderRadius: 10, padding: 4, width: "fit-content" }}>
        {[["pnl", "P&L & Waterfall"], ["fert", "Fertiliser Mix"], ["scenarios", "Scenarios"], ["insights", "Strategic Insights"]].map(([k, l]) => (
