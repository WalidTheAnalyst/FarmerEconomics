...
function AtlasFace({ state, audioLevel }) {
  ...
  return (
    <canvas
      ...
      style={{ filter: `drop-shadow(0 0 24px ${
    ...
    <div style={{ display: "flex", height: "calc(100vh - 108px)", background: "#060d1a", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", zIndex: 1, marginTop: -8 }}>
          ...
          <p style={{ color: "#334155", fontSize: 10, textTransform: "uppercase", letterSpacing: "0.14em", marginTop: 2 }}>
        ...
        <div style={{
          ...
          border: `1px solid ${stateColor[orbState]}35`, zIndex: 1,
        }}>
          <div style={{
        ...
        {/* Voice badge */}
        {voiceName && (
          <p style={{ color: "#334155", fontSize: 10, zIndex: 1 }}>
        ...
        {transcript && (
          <div style={{
            background: "#0f172a", border: "1px solid #10b98130",
            borderRadius: 8, padding: "7px 12px",
            fontSize: 11, color: "#10b981", fontStyle: "italic",
            maxWidth: "100%", overflow: "hidden",
            whiteSpace: "nowrap", textOverflow: "ellipsis", zIndex: 1,
          }}>
            "{transcript}"
          </div>
        )}
        ...
        <button
          ...
          style={{
            ...
            transform: isListening ? "scale(1.1)" : "scale(1)", zIndex: 1,
          }}
        >
        ...
        <p style={{ color: "#334155", fontSize: 11, textAlign: "center", zIndex: 1 }}>
          {isListening             ? "Listening — speak now"
            : orbState === "speaking" ? "Tap to interrupt ATLAS"
            : orbState === "thinking" ? "Processing…"
            : "Tap mic to speak with ATLAS"}
        </p>

        {error && (
          <div style={{
            background: "#1a0808", border: "1px solid #f43f5e30",
            borderRadius: 8, padding: "9px 12px", fontSize: 11,
            color: "#f87171", lineHeight: 1.6, width: "100%", zIndex: 1,
          }}>{error}</div>
        )}
        ...
        {messages.length > 0 && (
          <button onClick={clearConversation} style={{
            ...
            color: "#334155", fontSize: 11, padding: "6px 0",
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        {/* Messages */}
        <div style={{ flex: 1, overflowY: "auto", padding: "28px 30px", display: "flex", flexDirection: "column", gap: 18 }}>

          {messages.length === 0 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ padding: "18px 22px", background: "#0a0f1a", border: "1px solid #1e293b", borderRadius: 12 }}>
                ...
                {suggested.map((q, i) => (
                  <button key={i} onClick={() => askATLAS(q)}
                    style={{
                      ...
                      borderRadius: 10, padding: "13px 15px", textAlign: "left",
          ...
          {messages.map((msg, i) => (
            <div key={i} className="atlas-msg" style={{
              ...
              <div style={{
                ...
                <p style={{ color: msg.role === "user" ? "#94a3b8" : "#cbd5e1", fontSize: 13, lineHeight: 1.8, margin: 0, whiteSpace: "pre-wrap" }}>
                  {msg.text}
                </p>
              </div>
            </div>
          ...
          {orbState === "thinking" && (
            <div className="atlas-msg" style={{ display: "flex", gap: 11, alignItems: "flex-start" }}>
              <div style={{
              ...
              <div style={{ background: "#080d18", border: "1px solid #f59e0b18", borderRadius: "4px 14px 14px 14px", padding: "16px 18px", display: "flex", gap: 5, alignItems: "center" }}>
                {[0,1,2].map(j => (
                  <div key={j} style={{ width: 7, height: 7, borderRadius: "50%", background: "#f59e0b", animation: `pulse 0.9s ease-in-out ${j*0.2}s infinite` }} />
                ))}
              </div>
            </div>
          )}
        ...
        {/* Text input */}
        <div style={{ borderTop: "1px solid #1e293b", padding: "13px 30px", background: "#080d18", display: "flex", gap: 10 }}>
          <input
            type="text"
            ...
            style={{
              ...
              borderRadius: 10, padding: "11px 15px", color: "#e2e8f0",
          ...
          <button
            onClick={e => {
              ...
              if (inp.value.trim()) { askATLAS(inp.value.trim()); inp.value = ""; }
            }}
            style={{
              background: "linear-gradient(135deg,#818cf8,#4f46e5)",
              border: "none", borderRadius: 10, padding: "11px 22px",
              color: "#fff", fontSize: 13, fontWeight: 600, cursor: "pointer",
              boxShadow: "0 2px 12px #818cf830", transition: "all 0.15s",
            }}
            onMouseEnter={e => e.currentTarget.style.boxShadow = "0 4px 20px #818cf850"}
            onMouseLeave={e => e.currentTarget.style.boxShadow = "0 2px 12px #818cf830"}
          >Send</button>
        </div>
      </div>
    </div>
